...
// CIC kernel — Type inference and definitional equality.
...
public final class TypeChecker {
     ...
     */
    public static void checkConstant(Env env, ConstantInfo ci) {
        checkConstant(env, ci, DEFAULT_FUEL);
    }

    public static void checkConstant(Env env, ConstantInfo ci, long fuel) {
    ...
    public static void checkConstantTraced(Env env, ConstantInfo ci, long fuel, Writer traceWriter) {
        if (ci.isQuot()) {
            env.enableQuot();
            env.addConstant(ci);
            return;
