...
;; Pretty-printer for CIC expressions — renders human-readable Lean-like text.

(ns cic.surface.pp
  "Pretty-printer that renders CIC expressions as readable Lean-like text.
...
(defn pp
  "Pretty-print a CIC expression as readable Lean-like text.
