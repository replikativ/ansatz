...
--
--   cd ../mathlib4 && lake env lean --run ../ansatz-rel/scripts/dump_instances.lean Mathlib \
--     | gzip -c > ~/.local/share/ansatz/stores/mathlib/instances.tsv.gz
--
-- Then ansatz merges it via `ansatz.rel/load-instance-index!` (or /init! auto-loads
-- <store>/instances.tsv.gz). Defaults to Mathlib; pass module names as args to scope it.
import Lean
open Lean Meta
